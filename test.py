...
icon = pygame.image.load("UFO_abduction.png")
pygame.display.set_icon(icon)
logoImg = pygame.transform.scale(pygame.image.load("alien warning.png"), (187, 163))
titleImg = pygame.transform.scale(pygame.image.load("title.png"), (500, 73))
gameoverImg = pygame.transform.scale(pygame.image.load("gameover.png"), (406, 75))
restartImg = pygame.transform.scale(pygame.image.load("restart.png"), (250, 36))
right_arrow = pygame.image.load("right_arrow.png")
left_arrow = pygame.image.load("left_arrow.png")
# enterImg = pygame.transform.scale(pygame.image.load("enter.png"), (110, 42))

# Adding Sound Effects
start_music = mixer.Sound("Silent Owl.mp3")
background_music = mixer.Sound("MoriCalliopeBGM.mp3")
explosion_sound = mixer.Sound("Explosion effect.wav")
hit_sound = mixer.Sound("Hit effect.mp3")
...
upgrades2_image = pygame.transform.scale(pygame.image.load("sprite-fly1.png"), (128, 128))
...
# Background image
backgroundImg = pygame.transform.scale(pygame.image.load("cartoon-night-forest.png"), (screenWidth, screenHeight+20))
backgroundImg2 = pygame.transform.scale(pygame.image.load("cartoon-night-forest.png"), (290, 177))
scrollingBack = 0

# Heart life
heartImg = pygame.transform.scale(pygame.image.load("heart.png"), (39, 39))
...
# Battery image
BatteryList = []
battery0 = pygame.transform.scale(pygame.image.load("battery0.png"), (45, 75))
battery1 = pygame.transform.scale(pygame.image.load("battery1.png"), (45, 75))
battery2 = pygame.transform.scale(pygame.image.load("battery2.png"), (45, 75))
battery3 = pygame.transform.scale(pygame.image.load("battery3.png"), (45, 75))
battery4 = pygame.transform.scale(pygame.image.load("battery4.png"), (45, 75))
battery5 = pygame.transform.scale(pygame.image.load("battery5.png"), (45, 75))
...
# UFO image
ufoImg = pygame.transform.scale(pygame.image.load("ufo0.png"), (64, 64))
...
beamImg = pygame.transform.scale(pygame.image.load("yellow-beam.png"), (90, 100))
BEAMX = 0
BEAMY = 0
beam_tick = 0
beam_state = 'ready'
...
accumulatorImg = pygame.transform.scale(pygame.image.load("accumulator1.png"), (32, 32))
...
# Coin image
coinImg = pygame.transform.scale(pygame.image.load("Coin1.png"), (25, 26))
coin1Img = pygame.transform.scale(pygame.image.load("Coin1.png"), (16, 17))
...
# Explosion image
explosionImg = pygame.transform.scale(pygame.image.load("explosion.png"), (108, 98))
explode_state = 'ready'
explosion_tick = 0

# Bat Sprite
bat1 = pygame.transform.scale(pygame.image.load("sprite-fly1.png"), (48, 48))
bat2 = pygame.transform.scale(pygame.image.load("sprite-fly2.png"), (48, 48))
bat3 = pygame.transform.scale(pygame.image.load("sprite-fly3.png"), (48, 48))
bat4 = pygame.transform.scale(pygame.image.load("sprite-fly4.png"), (48, 48))
BATX = screenWidth
...
# Human Sprite
skinImg = pygame.transform.scale(pygame.image.load("christmas-hat.png"), (16, 16))
sprite1 = pygame.transform.scale(pygame.image.load("sprite-run1.png"), (35, 50))
sprite2 = pygame.transform.scale(pygame.image.load("sprite-run2.png"), (35, 50))
sprite3 = pygame.transform.scale(pygame.image.load("sprite-run3.png"), (35, 50))
sprite4 = pygame.transform.scale(pygame.image.load("sprite-run4.png"), (35, 50))
sprite5 = pygame.transform.scale(pygame.image.load("sprite-run5.png"), (35, 50))
sprite6 = pygame.transform.scale(pygame.image.load("sprite-run6.png"), (35, 50))
sprite7 = pygame.transform.scale(pygame.image.load("sprite-run7.png"), (35, 50))
SPRITEX = screenWidth
SPRITEY = 400
...
while running:
                ...
                if MENU_PAGE == 'map':
                    if 285 <= mouseX <= 445 and 355 <= mouseY <= 395:           # Play button pressed in Map Page
                        ...
                        if USER_DICT["ufo0"] == 1:
                            ...
                            ufoImg = pygame.transform.scale(pygame.image.load("ufo1.png"), (64, 64))
                        elif USER_DICT["ufo2"] == 1:
                            ufoImg = pygame.transform.scale(pygame.image.load("ufo2.png"), (64, 64))
                        ...
                        if USER_DICT["skin0"] == 1:
                            ...
                            SKIN = 2
                            skinImg = pygame.transform.scale(pygame.image.load("birthday-hat.png"), (16, 16))
                            human_sprite = Humansprite_animation(SPRITEX, SPRITEY, 'normal', SKIN)
                            animated_sprites.add(human_sprite)
    ...
    if CURRENT_SCREEN == 'GAME':
        ...
        if ABDUCTIONSCORE == 10 and BATAMOUNTS == 1:
            target_bat_sprite = Bat_animation(BATX, target_BATY, 'normal')
            animated_bats.add(target_bat_sprite)
            BATAMOUNTS += 1
        elif ABDUCTIONSCORE == 20 and BATAMOUNTS == 2:
            bat_sprite = Bat_animation(BATX, BATY, 'target')
            animated_bats.add(bat_sprite)
            BATAMOUNTS += 1
        elif ABDUCTIONSCORE == 40 + BATLEVEL2 and BATAMOUNTS == 3:
            bat_sprite = Bat_animation(BATX, BATY, 'normal')
            animated_bats.add(bat_sprite)
            BATAMOUNTS += 1
        elif ABDUCTIONSCORE == 80 + BATLEVEL3 and BATAMOUNTS == 4:
            bat_sprite = Bat_animation(BATX, BATY, 'normal')
            animated_bats.add(bat_sprite)
            BATAMOUNTS += 1
